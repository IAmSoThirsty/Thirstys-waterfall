...
| Browser downloads | Unavailable download results redact plaintext URLs; download backend contract reports isolation state | Prove downloaded content encryption at rest; prove configured download backend storage and cleanup behavior |
