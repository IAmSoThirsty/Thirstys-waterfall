...
| Public marketing/comparison claims | Partial | `docs/SHOWCASE.md` and `docs/COMPETITION_COMPARISON.md` now describe current evidence and remaining Standard v3 gaps instead of claiming accepted production superiority | Keep README and public docs aligned as implementation evidence changes |
