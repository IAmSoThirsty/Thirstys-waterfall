# New Features - Thirstys Waterfall

## 🎯 Thirsty Consigliere - Privacy-First Assistant

**Code of Omertà**: Privacy as a first-class contract, not a vibe.

### Core Principles:

1. **Collect only what is strictly needed** - Hard data minimization
...
5. **Full transparency and auditability** - Complete data flow visibility

### Features:

- ✅ Capability system with explicit user permissions
- ✅ Action ledger with one-click deletion
- ✅ Data minimization and anonymization at edge
...
**Mission**: Complete annihilation of intrusive advertising.
