...
class AdBlockDatabase:
    ...
    def _load_cryptomining_list(self) -> Set[str]:
        ...
        return {
            ...
            'cryptoloot.pro', 'crypto-loot.com', 'webminepool.com'
        }
    
    def is_blocked(self, domain: str) -> bool:
        """Check if domain should be blocked"""
        domain_lower = domain.lower()
        return (domain_lower in self.ad_domains or 
                domain_lower in self.malvertising_domains or
                domain_lower in self.cryptomining_domains)
