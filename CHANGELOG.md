...
- Refreshed release version after adding hosted CodeQL code scanning evidence.
- Kept target-host deployment, rollback, secret rotation, host network policy, and real VPN/firewall backend execution evidence as open Standard v3 blockers.
